...
@section('content')
  ...
  <section class="breadcrumb__wrap">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="breadcrumb__wrap__content">
                    <h2 class="title">{{$blog->blog_category_id}}</h2>ssets/
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$blog->blog_category_id}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="breadcrumb__wrap__icon">
        <ul>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon01.png')}}" alt=""></li>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon02.png')}}" alt=""></li>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon03.png')}}" alt=""></li>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon04.png')}}" alt=""></li>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon05.png')}}" alt=""></li>
            <li><img src="{{ asset('public/frontend/assets/img/icons/breadcrumb_icon06.png')}}" alt=""></li>
        </ul>
    </div>
</section>
<!-- breadcrumb-area-end -->
                        ...
                        <div class="row justify-content-between">
                                ...
                                <div class="blog__next__prev__item">
                                    ...
                                    <div class="blog__next__prev__post">
                                        <div class="blog__next__prev__thumb">
                                            <a href="blog-details.html"><img src="{{ asset('public/frontend/assets/img/blog/blog_prev.jpg')}}" alt=""></a>
                                        </div>
                            ...
                            <div class="col-xl-5 col-md-6">
                                <div class="blog__next__prev__item next_post text-end">
                                    ...
                                    <div class="blog__next__prev__post">
                                        <div class="blog__next__prev__thumb">
                                            <a href="blog-details.html"><img src="{{ asset('public/frontend/assets/img/blog/blog_next.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="blog__next__prev__content">
                        ...
                        <ul class="comment__list">
                            <li class="comment__item">
                                <div class="comment__thumb">
                                    <img src="{{ asset('public/frontend/assets/img/blog/comment_thumb01.png')}}" alt="">
                                </div>
                            ...
                            <li class="comment__item children">
                                <div class="comment__thumb">
                                    <img src="{{ asset('public/frontend/assets/img/blog/comment_thumb02.png')}}" alt="">
                                </div>
                                <div class="comment__content">
                                    <div class="comment__avatar__info">
                                        <div class="info">
                            ...
                            <li class="comment__item">
                                <div class="comment__thumb">
                                    <img src="{{ asset('public/frontend/assets/img/blog/comment_thumb03.png')}}" alt="">
                                </div>
                                <div class="comment__content">
                                    <div class="comment__avatar__info">
                                        <div class="info">
                            ...
                            <li class="comment__item children">
                                <div class="comment__thumb">
                                    <img src="{{ asset('public/frontend/assets/img/blog/comment_thumb04.png')}}" alt="">
                                </div>
                                <div class="comment__content">
                                    <div class="comment__avatar__info">
                                        <div class="info">
                ...
                <aside class="blog__sidebar">
                        ...
                        <ul class="rc__post">
                            ...
                            <li class="rc__post__item">
                                <div class="rc__post__thumb">
                                    <a href="blog-details.html"><img src="{{ asset($allblog->blog_image)}}" alt=""></a>
                                </div>
                                <div class="rc__post__content">
                                    <h5 class="title"><a href="blog-details.html">{{  $allblog->blog_title}}</a></h5>
                    ...
                    <div class="widget">
                        ...
                        <ul class="sidebar__cat">
                            ...
                            <li class="sidebar__cat__item"><a href="{{ route('blog.category',$cat->id)}}">{{$cat->blog_category}} (6)</a></li>
                            @endforeach
