                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" name="name" type="text":value="old('name')" id="name"   placeholder="Name" required autofocus />
                                    </div>
                                </div>
                              ...
                              <!-- Username -->
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" name="username" type="text":value="old('username')" id="username"   placeholder="username" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="password"   name="password" id="password" required autocomplete="new-password" placeholder="Password">
                                    </div>
                                </div>
